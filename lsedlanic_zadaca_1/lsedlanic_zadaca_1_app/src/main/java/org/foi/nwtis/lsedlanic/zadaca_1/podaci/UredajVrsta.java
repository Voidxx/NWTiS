...
public enum UredajVrsta {
	SenzorTemperatura(1), SenzorVlaga(2), SenzorTlak(3), SenzorSvjetlo(4), SenzorKontakt(5), SenzorTemperaturaVlaga(50),
	SenzorTemperaturaTlak(51), SenzorTemperaturaVlagaTlak(52), AktuatorVentilator(100), AktuatorGrijanje(101),
	AktuatorRasvjeta(102), AktuatorVrata(103);
